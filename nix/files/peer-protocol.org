...
:PROPERTIES:
:CUSTOM_ID: ai-pair-peer-protocol-v1
:END:
...
:PROPERTIES:
:CUSTOM_ID: triage-pivot-from-msg_id-to-trace
:END:
...
:PROPERTIES:
:CUSTOM_ID: tempo-210-footgun-do-not-use
:END:
...
:PROPERTIES:
:CUSTOM_ID: compatibility-with-other-consumers
:END:
